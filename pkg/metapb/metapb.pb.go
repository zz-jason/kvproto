...
func (StoreState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metapb_5f1ae7c9712adada, []int{0}
}
...
func (*StoreLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_5f1ae7c9712adada, []int{1}
}
...
type Store struct {
	...
	EngineAddress        string   `protobuf:"bytes,6,opt,name=engine_address,json=engineAddress,proto3" json:"engine_address,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*Store) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_5f1ae7c9712adada, []int{2}
}
...
func (m *Store) GetEngineAddress() string {
	if m != nil {
		return m.EngineAddress
	}
	return ""
}
...
func (*RegionEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_5f1ae7c9712adada, []int{3}
}
...
func (*Region) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_5f1ae7c9712adada, []int{4}
}
...
func (*Peer) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_5f1ae7c9712adada, []int{5}
}
...
func (m *Store) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EngineAddress) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(len(m.EngineAddress)))
		i += copy(dAtA[i:], m.EngineAddress)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Store) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EngineAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EngineAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMetapb(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("metapb.proto", fileDescriptor_metapb_5f1ae7c9712adada) }

var fileDescriptor_metapb_5f1ae7c9712adada = []byte{
	// 502 bytes of a gzipped FileDescriptorProto
	,
}
