...
func (DeadlockRequestType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_972337d718b37503, []int{0}
}
...
func (*WaitForEntriesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_972337d718b37503, []int{1}
}
...
func (*WaitForEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_972337d718b37503, []int{2}
}
...
func (*DeadlockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_972337d718b37503, []int{3}
}
...
func (*DeadlockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deadlock_972337d718b37503, []int{4}
}
...
func init() { proto.RegisterFile("deadlock.proto", fileDescriptor_deadlock_972337d718b37503) }

var fileDescriptor_deadlock_972337d718b37503 = []byte{
