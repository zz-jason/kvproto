...
func (*KeyRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_daf31eb8bbfdaf47, []int{0}
}
...
type Request struct {
	...
	// See `non_cacheable_data` in `Response`.
	NonCacheableData []byte      `protobuf:"bytes,9,opt,name=non_cacheable_data,json=nonCacheableData,proto3" json:"non_cacheable_data,omitempty"`
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_daf31eb8bbfdaf47, []int{1}
}
...
func (m *Request) GetNonCacheableData() []byte {
	if m != nil {
		return m.NonCacheableData
	}
	return nil
}
...
type Response struct {
	...
	// `data` may be cached. Those data that don't want to be cached can be put in `non_cacheable_data`.
	NonCacheableData     github_com_pingcap_kvproto_pkg_sharedbytes.SharedBytes `protobuf:"bytes,9,opt,name=non_cacheable_data,json=nonCacheableData,proto3,customtype=github.com/pingcap/kvproto/pkg/sharedbytes.SharedBytes" json:"non_cacheable_data"`
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_daf31eb8bbfdaf47, []int{2}
}
...
func (m *Request) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.NonCacheableData) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintCoprocessor(dAtA, i, uint64(len(m.NonCacheableData)))
		i += copy(dAtA[i:], m.NonCacheableData)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Response) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x4a
	i++
	i = encodeVarintCoprocessor(dAtA, i, uint64(m.NonCacheableData.Size()))
	n7, err := m.NonCacheableData.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n7
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NonCacheableData", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NonCacheableData = append(m.NonCacheableData[:0], dAtA[iNdEx:postIndex]...)
			if m.NonCacheableData == nil {
				m.NonCacheableData = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if err := m.NonCacheableData.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("coprocessor.proto", fileDescriptor_coprocessor_daf31eb8bbfdaf47) }

var fileDescriptor_coprocessor_daf31eb8bbfdaf47 = []byte{
	// 599 bytes of a gzipped FileDescriptorProto
	,
}
