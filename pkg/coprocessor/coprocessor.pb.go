...
func (*KeyRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_bc259b8e05617443, []int{0}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_bc259b8e05617443, []int{1}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_bc259b8e05617443, []int{2}
}
...
func (*RegionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_bc259b8e05617443, []int{3}
}
...
func (*BatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_bc259b8e05617443, []int{4}
}
...
func (*BatchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_coprocessor_bc259b8e05617443, []int{5}
}
...
func init() { proto.RegisterFile("coprocessor.proto", fileDescriptor_coprocessor_bc259b8e05617443) }

var fileDescriptor_coprocessor_bc259b8e05617443 = []byte{
	// 708 bytes of a gzipped FileDescriptorProto
	,
}
