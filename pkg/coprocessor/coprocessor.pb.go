...
type Response struct {
	...
	RuntimeDetails *kvrpcpb.RunTimeDetails                         `protobuf:"bytes,6,opt,name=runtime_details,json=runtimeDetails" json:"runtime_details,omitempty"`
}
...
func (m *Response) GetRuntimeDetails() *kvrpcpb.RunTimeDetails {
	if m != nil {
		return m.RuntimeDetails
	}
	return nil
}
...
func (m *Response) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RuntimeDetails != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintCoprocessor(dAtA, i, uint64(m.RuntimeDetails.Size()))
		n6, err := m.RuntimeDetails.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RuntimeDetails", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RuntimeDetails == nil {
				m.RuntimeDetails = &kvrpcpb.RunTimeDetails{}
			}
			if err := m.RuntimeDetails.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorCoprocessor = []byte{
	...
	,
}
