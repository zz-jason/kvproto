...
type BatchSplitRequest struct {
	...
	// Which region derives the origin region id.
	DerivePos uint64 `protobuf:"varint,2,opt,name=derive_pos,json=derivePos,proto3" json:"derive_pos,omitempty"`
}
...
func (m *BatchSplitRequest) GetDerivePos() uint64 {
	if m != nil {
		return m.DerivePos
	}
	return 0
...
func (m *BatchSplitRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DerivePos != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.DerivePos))
	}
	return i, nil
}
...
func (m *BatchSplitRequest) Size() (n int) {
	...
	if m.DerivePos != 0 {
		n += 1 + sovRaftCmdpb(uint64(m.DerivePos))
	}
	return n
}
...
func (m *BatchSplitRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DerivePos", wireType)
			}
			m.DerivePos = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DerivePos |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
