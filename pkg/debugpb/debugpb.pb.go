...
type DebugClient interface {
	...
	CheckRegionConsistency(ctx context.Context, in *RegionConsistentCheckRequest, opts ...grpc.CallOption) (*RegionConsistentCheckResponse, error)
}
...
func (c *debugClient) CheckRegionConsistency(ctx context.Context, in *RegionConsistentCheckRequest, opts ...grpc.CallOption) (*RegionConsistentCheckResponse, error) {
...
type DebugServer interface {
	...
	// Do a consistent check for a region.
	CheckRegionConsistency(context.Context, *RegionConsistentCheckRequest) (*RegionConsistentCheckResponse, error)
}
...
func _Debug_CheckRegionConsistency_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).CheckRegionConsistency(ctx, req.(*RegionConsistentCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorDebugpb = []byte{
	...
	,
}
