...
pub trait Debug {
fn get(&mut self, ctx: ::grpcio::RpcContext, req: GetRequest, sink: ::grpcio::UnarySink<GetResponse>);
fn raft_log(&mut self, ctx: ::grpcio::RpcContext, req: RaftLogRequest, sink: ::grpcio::UnarySink<RaftLogResponse>);
fn region_info(&mut self, ctx: ::grpcio::RpcContext, req: RegionInfoRequest, sink: ::grpcio::UnarySink<RegionInfoResponse>);
fn region_size(&mut self, ctx: ::grpcio::RpcContext, req: RegionSizeRequest, sink: ::grpcio::UnarySink<RegionSizeResponse>);
fn scan_mvcc(&mut self, ctx: ::grpcio::RpcContext, req: ScanMvccRequest, sink: ::grpcio::ServerStreamingSink<ScanMvccResponse>);
fn compact(&mut self, ctx: ::grpcio::RpcContext, req: CompactRequest, sink: ::grpcio::UnarySink<CompactResponse>);
fn inject_fail_point(&mut self, ctx: ::grpcio::RpcContext, req: InjectFailPointRequest, sink: ::grpcio::UnarySink<InjectFailPointResponse>);
fn recover_fail_point(&mut self, ctx: ::grpcio::RpcContext, req: RecoverFailPointRequest, sink: ::grpcio::UnarySink<RecoverFailPointResponse>);
fn list_fail_points(&mut self, ctx: ::grpcio::RpcContext, req: ListFailPointsRequest, sink: ::grpcio::UnarySink<ListFailPointsResponse>);
fn get_metrics(&mut self, ctx: ::grpcio::RpcContext, req: GetMetricsRequest, sink: ::grpcio::UnarySink<GetMetricsResponse>);
fn check_region_consistency(&mut self, ctx: ::grpcio::RpcContext, req: RegionConsistencyCheckRequest, sink: ::grpcio::UnarySink<RegionConsistencyCheckResponse>);
fn modify_tikv_config(&mut self, ctx: ::grpcio::RpcContext, req: ModifyTikvConfigRequest, sink: ::grpcio::UnarySink<ModifyTikvConfigResponse>);
fn get_region_properties(&mut self, ctx: ::grpcio::RpcContext, req: GetRegionPropertiesRequest, sink: ::grpcio::UnarySink<GetRegionPropertiesResponse>);
}
