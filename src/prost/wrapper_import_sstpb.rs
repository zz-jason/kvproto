...
#[inline] pub fn set_mode_(&mut self, v: SwitchMode) { self.mode = unsafe { ::std::mem::transmute::<SwitchMode, i32>(v) }; }
#[inline] pub fn get_mode(&self) -> SwitchMode { unsafe { ::std::mem::transmute::<i32, SwitchMode>(self.mode) } }
}
...
#[inline] pub fn set_start(&mut self, v: std :: vec :: Vec < u8 >) { self.start = v; }
#[inline] pub fn get_start(&self) -> &[u8] { &self.start }
#[inline] pub fn mut_start(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.start }
#[inline] pub fn take_start(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.start, ::std::vec::Vec::new()) }
#[inline] pub fn clear_end(&mut self) { self.end.clear(); }
#[inline] pub fn set_end(&mut self, v: std :: vec :: Vec < u8 >) { self.end = v; }
#[inline] pub fn get_end(&self) -> &[u8] { &self.end }
#[inline] pub fn mut_end(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.end }
#[inline] pub fn take_end(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.end, ::std::vec::Vec::new()) }
}
...
#[inline] pub fn set_cf_name(&mut self, v: std :: string :: String) { self.cf_name = v; }
#[inline] pub fn get_cf_name(&self) -> &str { &self.cf_name }
#[inline] pub fn mut_cf_name(&mut self) -> &mut std :: string :: String { &mut self.cf_name }
#[inline] pub fn take_cf_name(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.cf_name, ::std::string::String::new()) }
