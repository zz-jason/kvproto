...
#[inline] pub fn set_lock(&mut self, v: std :: vec :: Vec < u8 >) { self.lock = v; }
#[inline] pub fn get_lock(&self) -> &[u8] { &self.lock }
#[inline] pub fn mut_lock(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.lock }
#[inline] pub fn take_lock(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.lock, ::std::vec::Vec::new()) }
}
...
#[inline] pub fn set_cmd_type_(&mut self, v: CmdType) { self.cmd_type = unsafe { ::std::mem::transmute::<CmdType, i32>(v) }; }
#[inline] pub fn get_cmd_type(&self) -> CmdType { unsafe { ::std::mem::transmute::<i32, CmdType>(self.cmd_type) } }
...
#[inline] pub fn get_requests(&self) -> &:: std :: vec :: Vec < SplitRequest > { &self.requests }
...
#[inline] pub fn set_hash(&mut self, v: std :: vec :: Vec < u8 >) { self.hash = v; }
#[inline] pub fn get_hash(&self) -> &[u8] { &self.hash }
#[inline] pub fn mut_hash(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.hash }
#[inline] pub fn take_hash(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.hash, ::std::vec::Vec::new()) }
}
...
#[inline] pub fn get_entries(&self) -> &:: std :: vec :: Vec < super :: eraftpb :: Entry > { &self.entries }
...
#[inline] pub fn clear_cmd_type(&mut self) { self.cmd_type = 0 }
#[inline] pub fn set_cmd_type_(&mut self, v: AdminCmdType) { self.cmd_type = unsafe { ::std::mem::transmute::<AdminCmdType, i32>(v) }; }
#[inline] pub fn get_cmd_type(&self) -> AdminCmdType { unsafe { ::std::mem::transmute::<i32, AdminCmdType>(self.cmd_type) } }
...
#[inline] pub fn has_split(&self) -> bool { self.split.is_some() }
#[inline] pub fn clear_split(&mut self) { self.split = ::std::option::Option::None }
#[inline] pub fn set_split(&mut self, v: SplitRequest) { self.split = ::std::option::Option::Some(v); }
#[inline] pub fn get_split(&self) -> &SplitRequest { match self.split.as_ref() {
                            Some(v) => v,
                            None => <SplitRequest as ::protobuf::Message>::default_instance(),
                        } }
#[inline] pub fn mut_split(&mut self) -> &mut SplitRequest { if self.split.is_none() {
                                self.split = ::std::option::Option::Some(SplitRequest::default());
                            }
                            self.split.as_mut().unwrap() } 
#[inline] pub fn take_split(&mut self) -> SplitRequest { self.split.take().unwrap_or_else(SplitRequest::default) }
...
#[inline] pub fn has_split(&self) -> bool { self.split.is_some() }
#[inline] pub fn clear_split(&mut self) { self.split = ::std::option::Option::None }
#[inline] pub fn set_split(&mut self, v: SplitResponse) { self.split = ::std::option::Option::Some(v); }
#[inline] pub fn get_split(&self) -> &SplitResponse { match self.split.as_ref() {
                            Some(v) => v,
                            None => <SplitResponse as ::protobuf::Message>::default_instance(),
                        } }
#[inline] pub fn mut_split(&mut self) -> &mut SplitResponse { if self.split.is_none() {
                                self.split = ::std::option::Option::Some(SplitResponse::default());
                            }
                            self.split.as_mut().unwrap() } 
#[inline] pub fn take_split(&mut self) -> SplitResponse { self.split.take().unwrap_or_else(SplitResponse::default) }
#[inline] pub fn has_compact_log(&self) -> bool { self.compact_log.is_some() }
#[inline] pub fn clear_compact_log(&mut self) { self.compact_log = ::std::option::Option::None }
...
#[inline] pub fn clear_cmd_type(&mut self) { self.cmd_type = 0 }
#[inline] pub fn set_cmd_type_(&mut self, v: StatusCmdType) { self.cmd_type = unsafe { ::std::mem::transmute::<StatusCmdType, i32>(v) }; }
#[inline] pub fn get_cmd_type(&self) -> StatusCmdType { unsafe { ::std::mem::transmute::<i32, StatusCmdType>(self.cmd_type) } }
...
#[inline] pub fn set_uuid(&mut self, v: std :: vec :: Vec < u8 >) { self.uuid = v; }
#[inline] pub fn get_uuid(&self) -> &[u8] { &self.uuid }
#[inline] pub fn mut_uuid(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.uuid }
#[inline] pub fn take_uuid(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.uuid, ::std::vec::Vec::new()) }
...
#[inline] pub fn get_requests(&self) -> &:: std :: vec :: Vec < Request > { &self.requests }
...
#[inline] pub fn get_responses(&self) -> &:: std :: vec :: Vec < Response > { &self.responses }
