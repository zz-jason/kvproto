...
fn upload(&mut self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<UploadRequest>, sink: ::grpcio::ClientStreamingSink<UploadResponse>);
fn ingest(&mut self, ctx: ::grpcio::RpcContext, req: IngestRequest, sink: ::grpcio::UnarySink<IngestResponse>);
