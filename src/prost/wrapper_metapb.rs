...
#[inline] pub fn set_key(&mut self, v: std :: string :: String) { self.key = v; }
#[inline] pub fn get_key(&self) -> &str { &self.key }
#[inline] pub fn mut_key(&mut self) -> &mut std :: string :: String { &mut self.key }
#[inline] pub fn take_key(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.key, ::std::string::String::new()) }
...
#[inline] pub fn set_state_(&mut self, v: StoreState) { self.state = unsafe { ::std::mem::transmute::<StoreState, i32>(v) }; }
#[inline] pub fn get_state(&self) -> StoreState { unsafe { ::std::mem::transmute::<i32, StoreState>(self.state) } }
...
#[inline] pub fn get_labels(&self) -> &:: std :: vec :: Vec < StoreLabel > { &self.labels }
...
#[inline] pub fn set_version(&mut self, v: std :: string :: String) { self.version = v; }
#[inline] pub fn get_version(&self) -> &str { &self.version }
#[inline] pub fn mut_version(&mut self) -> &mut std :: string :: String { &mut self.version }
#[inline] pub fn take_version(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.version, ::std::string::String::new()) }
}
...
#[inline] pub fn get_peers(&self) -> &:: std :: vec :: Vec < Peer > { &self.peers }
...
#[inline] pub fn clear_is_learner(&mut self) { self.is_learner = false }
#[inline] pub fn set_is_learner(&mut self, v: bool) { self.is_learner = v; }
#[inline] pub fn get_is_learner(&self) -> bool { self.is_learner }
}
