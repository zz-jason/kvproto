...
#[inline] pub fn set_primary_lock(&mut self, v: std :: vec :: Vec < u8 >) { self.primary_lock = v; }
#[inline] pub fn get_primary_lock(&self) -> &[u8] { &self.primary_lock }
#[inline] pub fn mut_primary_lock(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.primary_lock }
#[inline] pub fn take_primary_lock(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.primary_lock, ::std::vec::Vec::new()) }
...
#[inline] pub fn set_retryable(&mut self, v: std :: string :: String) { self.retryable = v; }
...
#[inline] pub fn take_retryable(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.retryable, ::std::string::String::new()) }
#[inline] pub fn clear_abort(&mut self) { self.abort.clear(); }
#[inline] pub fn set_abort(&mut self, v: std :: string :: String) { self.abort = v; }
#[inline] pub fn get_abort(&self) -> &str { &self.abort }
#[inline] pub fn mut_abort(&mut self) -> &mut std :: string :: String { &mut self.abort }
#[inline] pub fn take_abort(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.abort, ::std::string::String::new()) }
...
#[inline] pub fn set_primary(&mut self, v: std :: vec :: Vec < u8 >) { self.primary = v; }
...
#[inline] pub fn set_priority_(&mut self, v: CommandPri) { self.priority = unsafe { ::std::mem::transmute::<CommandPri, i32>(v) }; }
#[inline] pub fn get_priority(&self) -> CommandPri { unsafe { ::std::mem::transmute::<i32, CommandPri>(self.priority) } }
#[inline] pub fn clear_isolation_level(&mut self) { self.isolation_level = 0 }
#[inline] pub fn set_isolation_level_(&mut self, v: IsolationLevel) { self.isolation_level = unsafe { ::std::mem::transmute::<IsolationLevel, i32>(v) }; }
#[inline] pub fn get_isolation_level(&self) -> IsolationLevel { unsafe { ::std::mem::transmute::<i32, IsolationLevel>(self.isolation_level) } }
...
#[inline] pub fn clear_handle_time(&mut self) { self.handle_time = false }
#[inline] pub fn set_handle_time(&mut self, v: bool) { self.handle_time = v; }
#[inline] pub fn get_handle_time(&self) -> bool { self.handle_time }
#[inline] pub fn clear_scan_detail(&mut self) { self.scan_detail = false }
#[inline] pub fn set_scan_detail(&mut self, v: bool) { self.scan_detail = v; }
#[inline] pub fn get_scan_detail(&self) -> bool { self.scan_detail }
}
...
impl HandleTime {
pub fn new_() -> HandleTime { ::std::default::Default::default() }
#[inline] pub fn clear_wait_ms(&mut self) { self.wait_ms = 0 }
#[inline] pub fn set_wait_ms(&mut self, v: i64) { self.wait_ms = v; }
#[inline] pub fn get_wait_ms(&self) -> i64 { self.wait_ms }
#[inline] pub fn clear_process_ms(&mut self) { self.process_ms = 0 }
#[inline] pub fn set_process_ms(&mut self, v: i64) { self.process_ms = v; }
#[inline] pub fn get_process_ms(&self) -> i64 { self.process_ms }
}
impl ::protobuf::Clear for HandleTime {fn clear(&mut self) { ::prost::Message::clear(self); }
}
impl ::protobuf::Message for HandleTime {fn compute_size(&self) -> u32 { ::prost::Message::encoded_len(self) as u32 }
fn get_cached_size(&self) -> u32 { ::prost::Message::encoded_len(self) as u32 }
fn as_any(&self) -> &::std::any::Any { self as &::std::any::Any }
fn descriptor(&self) -> &'static ::protobuf::reflect::MessageDescriptor { Self::descriptor_static() }
fn new() -> Self { Self::new_() }
...
#[inline] pub fn has_handle_time(&self) -> bool { self.handle_time.is_some() }
#[inline] pub fn clear_handle_time(&mut self) { self.handle_time = ::std::option::Option::None }
#[inline] pub fn set_handle_time(&mut self, v: HandleTime) { self.handle_time = ::std::option::Option::Some(v); }
#[inline] pub fn get_handle_time(&self) -> &HandleTime { match self.handle_time.as_ref() {
                            Some(v) => v,
                            None => <HandleTime as ::protobuf::Message>::default_instance(),
                        } }
#[inline] pub fn mut_handle_time(&mut self) -> &mut HandleTime { if self.handle_time.is_none() {
                                self.handle_time = ::std::option::Option::Some(HandleTime::default());
                            }
                            self.handle_time.as_mut().unwrap() } 
#[inline] pub fn take_handle_time(&mut self) -> HandleTime { self.handle_time.take().unwrap_or_else(HandleTime::default) }
...
#[inline] pub fn set_value(&mut self, v: std :: vec :: Vec < u8 >) { self.value = v; }
#[inline] pub fn get_value(&self) -> &[u8] { &self.value }
#[inline] pub fn mut_value(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.value }
#[inline] pub fn take_value(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.value, ::std::vec::Vec::new()) }
}
...
#[inline] pub fn set_end_key(&mut self, v: std :: vec :: Vec < u8 >) { self.end_key = v; }
...
#[inline] pub fn get_pairs(&self) -> &:: std :: vec :: Vec < KvPair > { &self.pairs }
...
#[inline] pub fn set_op_(&mut self, v: Op) { self.op = unsafe { ::std::mem::transmute::<Op, i32>(v) }; }
#[inline] pub fn get_op(&self) -> Op { unsafe { ::std::mem::transmute::<i32, Op>(self.op) } }
#[inline] pub fn clear_key(&mut self) { self.key.clear(); }
#[inline] pub fn set_key(&mut self, v: std :: vec :: Vec < u8 >) { self.key = v; }
#[inline] pub fn get_key(&self) -> &[u8] { &self.key }
#[inline] pub fn mut_key(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.key }
...
#[inline] pub fn set_assertion_(&mut self, v: Assertion) { self.assertion = unsafe { ::std::mem::transmute::<Assertion, i32>(v) }; }
#[inline] pub fn get_assertion(&self) -> Assertion { unsafe { ::std::mem::transmute::<i32, Assertion>(self.assertion) } }
}
...
#[inline] pub fn get_mutations(&self) -> &:: std :: vec :: Vec < Mutation > { &self.mutations }
...
#[inline] pub fn get_is_pessimistic_lock(&self) -> &:: std :: vec :: Vec < bool > { &self.is_pessimistic_lock }
...
#[inline] pub fn set_error(&mut self, v: std :: string :: String) { self.error = v; }
#[inline] pub fn get_error(&self) -> &str { &self.error }
#[inline] pub fn mut_error(&mut self) -> &mut std :: string :: String { &mut self.error }
#[inline] pub fn take_error(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.error, ::std::string::String::new()) }
}
...
#[inline] pub fn get_locks(&self) -> &:: std :: vec :: Vec < LockInfo > { &self.locks }
...
#[inline] pub fn get_txn_infos(&self) -> &:: std :: vec :: Vec < TxnInfo > { &self.txn_infos }
...
#[inline] pub fn set_cf(&mut self, v: std :: string :: String) { self.cf = v; }
#[inline] pub fn get_cf(&self) -> &str { &self.cf }
#[inline] pub fn mut_cf(&mut self) -> &mut std :: string :: String { &mut self.cf }
#[inline] pub fn take_cf(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.cf, ::std::string::String::new()) }
}
...
#[inline] pub fn get_kvs(&self) -> &:: std :: vec :: Vec < KvPair > { &self.kvs }
...
#[inline] pub fn get_ranges(&self) -> &:: std :: vec :: Vec < KeyRange > { &self.ranges }
...
#[inline] pub fn clear_field_type(&mut self) { self.r#type = 0 }
#[inline] pub fn set_field_type_(&mut self, v: Op) { self.r#type = unsafe { ::std::mem::transmute::<Op, i32>(v) }; }
#[inline] pub fn get_field_type(&self) -> Op { unsafe { ::std::mem::transmute::<i32, Op>(self.r#type) } }
#[inline] pub fn clear_start_ts(&mut self) { self.start_ts = 0 }
#[inline] pub fn set_start_ts(&mut self, v: u64) { self.start_ts = v; }
#[inline] pub fn get_start_ts(&self) -> u64 { self.start_ts }
...
#[inline] pub fn set_short_value(&mut self, v: std :: vec :: Vec < u8 >) { self.short_value = v; }
#[inline] pub fn get_short_value(&self) -> &[u8] { &self.short_value }
#[inline] pub fn mut_short_value(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.short_value }
#[inline] pub fn take_short_value(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.short_value, ::std::vec::Vec::new()) }
}
...
#[inline] pub fn get_writes(&self) -> &:: std :: vec :: Vec < MvccWrite > { &self.writes }
...
#[inline] pub fn get_values(&self) -> &:: std :: vec :: Vec < MvccValue > { &self.values }
...
#[inline] pub fn set_split_key(&mut self, v: std :: vec :: Vec < u8 >) { self.split_key = v; }
#[inline] pub fn get_split_key(&self) -> &[u8] { &self.split_key }
#[inline] pub fn mut_split_key(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.split_key }
#[inline] pub fn take_split_key(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.split_key, ::std::vec::Vec::new()) }
}
