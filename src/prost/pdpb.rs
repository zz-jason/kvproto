...
const METHOD_PD_SCAN_REGIONS: ::grpcio::Method<ScanRegionsRequest, ScanRegionsResponse> =
    ::grpcio::Method {
        ty: ::grpcio::MethodType::Unary,
...
impl PdClient {
    ...
    pub fn scan_regions_opt(
        ...
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<ScanRegionsResponse> {
        self.client.unary_call(&METHOD_PD_SCAN_REGIONS, req, opt)
    }
    pub fn scan_regions(&self, req: &ScanRegionsRequest) -> ::grpcio::Result<ScanRegionsResponse> {
    ...
    pub fn scan_regions_async_opt(
        ...
        req: &ScanRegionsRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<ScanRegionsResponse>> {
        self.client
            .unary_call_async(&METHOD_PD_SCAN_REGIONS, req, opt)
    }
