...
pub struct ScanRegionsResponse {
    ...
    pub leaders: ::std::vec::Vec<super::metapb::Peer>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub fn spawn<F>(&self, f: F) where F: ::futures::Future<Item = (), Error = ()> + Send + 'static {self.client.spawn(f)}
}
pub trait Pd {
fn get_members(&mut self, ctx: ::grpcio::RpcContext, req: GetMembersRequest, sink: ::grpcio::UnarySink<GetMembersResponse>);
fn tso(&mut self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<TsoRequest>, sink: ::grpcio::DuplexSink<TsoResponse>);
fn bootstrap(&mut self, ctx: ::grpcio::RpcContext, req: BootstrapRequest, sink: ::grpcio::UnarySink<BootstrapResponse>);
fn is_bootstrapped(&mut self, ctx: ::grpcio::RpcContext, req: IsBootstrappedRequest, sink: ::grpcio::UnarySink<IsBootstrappedResponse>);
fn alloc_id(&mut self, ctx: ::grpcio::RpcContext, req: AllocIdRequest, sink: ::grpcio::UnarySink<AllocIdResponse>);
fn get_store(&mut self, ctx: ::grpcio::RpcContext, req: GetStoreRequest, sink: ::grpcio::UnarySink<GetStoreResponse>);
fn put_store(&mut self, ctx: ::grpcio::RpcContext, req: PutStoreRequest, sink: ::grpcio::UnarySink<PutStoreResponse>);
fn get_all_stores(&mut self, ctx: ::grpcio::RpcContext, req: GetAllStoresRequest, sink: ::grpcio::UnarySink<GetAllStoresResponse>);
fn store_heartbeat(&mut self, ctx: ::grpcio::RpcContext, req: StoreHeartbeatRequest, sink: ::grpcio::UnarySink<StoreHeartbeatResponse>);
fn region_heartbeat(&mut self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<RegionHeartbeatRequest>, sink: ::grpcio::DuplexSink<RegionHeartbeatResponse>);
fn get_region(&mut self, ctx: ::grpcio::RpcContext, req: GetRegionRequest, sink: ::grpcio::UnarySink<GetRegionResponse>);
fn get_prev_region(&mut self, ctx: ::grpcio::RpcContext, req: GetRegionRequest, sink: ::grpcio::UnarySink<GetRegionResponse>);
fn get_region_by_id(&mut self, ctx: ::grpcio::RpcContext, req: GetRegionByIdRequest, sink: ::grpcio::UnarySink<GetRegionResponse>);
fn scan_regions(&mut self, ctx: ::grpcio::RpcContext, req: ScanRegionsRequest, sink: ::grpcio::UnarySink<ScanRegionsResponse>);
fn ask_split(&mut self, ctx: ::grpcio::RpcContext, req: AskSplitRequest, sink: ::grpcio::UnarySink<AskSplitResponse>);
fn report_split(&mut self, ctx: ::grpcio::RpcContext, req: ReportSplitRequest, sink: ::grpcio::UnarySink<ReportSplitResponse>);
fn ask_batch_split(&mut self, ctx: ::grpcio::RpcContext, req: AskBatchSplitRequest, sink: ::grpcio::UnarySink<AskBatchSplitResponse>);
fn report_batch_split(&mut self, ctx: ::grpcio::RpcContext, req: ReportBatchSplitRequest, sink: ::grpcio::UnarySink<ReportBatchSplitResponse>);
fn get_cluster_config(&mut self, ctx: ::grpcio::RpcContext, req: GetClusterConfigRequest, sink: ::grpcio::UnarySink<GetClusterConfigResponse>);
fn put_cluster_config(&mut self, ctx: ::grpcio::RpcContext, req: PutClusterConfigRequest, sink: ::grpcio::UnarySink<PutClusterConfigResponse>);
fn scatter_region(&mut self, ctx: ::grpcio::RpcContext, req: ScatterRegionRequest, sink: ::grpcio::UnarySink<ScatterRegionResponse>);
fn get_gc_safe_point(&mut self, ctx: ::grpcio::RpcContext, req: GetGcSafePointRequest, sink: ::grpcio::UnarySink<GetGcSafePointResponse>);
fn update_gc_safe_point(&mut self, ctx: ::grpcio::RpcContext, req: UpdateGcSafePointRequest, sink: ::grpcio::UnarySink<UpdateGcSafePointResponse>);
fn sync_regions(&mut self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<SyncRegionRequest>, sink: ::grpcio::DuplexSink<SyncRegionResponse>);
fn get_operator(&mut self, ctx: ::grpcio::RpcContext, req: GetOperatorRequest, sink: ::grpcio::UnarySink<GetOperatorResponse>);
}
