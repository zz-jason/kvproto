...
#[inline] pub fn set_other_error(&mut self, v: std :: string :: String) { self.other_error = v; }
#[inline] pub fn get_other_error(&self) -> &str { &self.other_error }
#[inline] pub fn mut_other_error(&mut self) -> &mut std :: string :: String { &mut self.other_error }
#[inline] pub fn take_other_error(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.other_error, ::std::string::String::new()) }
