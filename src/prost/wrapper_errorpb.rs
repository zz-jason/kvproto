...
#[inline] pub fn get_current_regions(&self) -> &:: std :: vec :: Vec < super :: metapb :: Region > { &self.current_regions }
...
#[inline] pub fn set_reason(&mut self, v: std :: string :: String) { self.reason = v; }
#[inline] pub fn get_reason(&self) -> &str { &self.reason }
#[inline] pub fn mut_reason(&mut self) -> &mut std :: string :: String { &mut self.reason }
#[inline] pub fn take_reason(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.reason, ::std::string::String::new()) }
