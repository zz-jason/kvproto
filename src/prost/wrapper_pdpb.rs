...
#[inline] pub fn set_field_type_(&mut self, v: ErrorType) { self.r#type = unsafe { ::std::mem::transmute::<ErrorType, i32>(v) }; }
#[inline] pub fn get_field_type(&self) -> ErrorType { unsafe { ::std::mem::transmute::<i32, ErrorType>(self.r#type) } }
#[inline] pub fn clear_message(&mut self) { self.message.clear(); }
#[inline] pub fn set_message(&mut self, v: std :: string :: String) { self.message = v; }
#[inline] pub fn get_message(&self) -> &str { &self.message }
#[inline] pub fn mut_message(&mut self) -> &mut std :: string :: String { &mut self.message }
#[inline] pub fn take_message(&mut self) -> std :: string :: String { ::std::mem::replace(&mut self.message, ::std::string::String::new()) }
}
...
#[inline] pub fn get_stores(&self) -> &:: std :: vec :: Vec < super :: metapb :: Store > { &self.stores }
...
#[inline] pub fn clear_slaves(&mut self) { self.slaves.clear(); }
#[inline] pub fn set_slaves(&mut self, v: :: std :: vec :: Vec < super :: metapb :: Peer >) { self.slaves = v; }
#[inline] pub fn get_slaves(&self) -> &:: std :: vec :: Vec < super :: metapb :: Peer > { &self.slaves }
#[inline] pub fn mut_slaves(&mut self) -> &mut :: std :: vec :: Vec < super :: metapb :: Peer > { &mut self.slaves }
#[inline] pub fn take_slaves(&mut self) -> :: std :: vec :: Vec < super :: metapb :: Peer > { ::std::mem::replace(&mut self.slaves, ::std::vec::Vec::new()) }
}
...
#[inline] pub fn set_peer_urls(&mut self, v: :: std :: vec :: Vec < std :: string :: String >) { self.peer_urls = v; }
#[inline] pub fn get_peer_urls(&self) -> &:: std :: vec :: Vec < std :: string :: String > { &self.peer_urls }
#[inline] pub fn mut_peer_urls(&mut self) -> &mut :: std :: vec :: Vec < std :: string :: String > { &mut self.peer_urls }
#[inline] pub fn take_peer_urls(&mut self) -> :: std :: vec :: Vec < std :: string :: String > { ::std::mem::replace(&mut self.peer_urls, ::std::vec::Vec::new()) }
#[inline] pub fn clear_client_urls(&mut self) { self.client_urls.clear(); }
#[inline] pub fn set_client_urls(&mut self, v: :: std :: vec :: Vec < std :: string :: String >) { self.client_urls = v; }
#[inline] pub fn get_client_urls(&self) -> &:: std :: vec :: Vec < std :: string :: String > { &self.client_urls }
#[inline] pub fn mut_client_urls(&mut self) -> &mut :: std :: vec :: Vec < std :: string :: String > { &mut self.client_urls }
#[inline] pub fn take_client_urls(&mut self) -> :: std :: vec :: Vec < std :: string :: String > { ::std::mem::replace(&mut self.client_urls, ::std::vec::Vec::new()) }
...
#[inline] pub fn get_members(&self) -> &:: std :: vec :: Vec < Member > { &self.members }
...
#[inline] pub fn get_down_peers(&self) -> &:: std :: vec :: Vec < PeerStats > { &self.down_peers }
...
#[inline] pub fn get_pending_peers(&self) -> &:: std :: vec :: Vec < super :: metapb :: Peer > { &self.pending_peers }
...
#[inline] pub fn set_change_type_(&mut self, v: super::eraftpb::ConfChangeType) { self.change_type = unsafe { ::std::mem::transmute::<super::eraftpb::ConfChangeType, i32>(v) }; }
#[inline] pub fn get_change_type(&self) -> super::eraftpb::ConfChangeType { unsafe { ::std::mem::transmute::<i32, super::eraftpb::ConfChangeType>(self.change_type) } }
}
...
#[inline] pub fn set_policy_(&mut self, v: CheckPolicy) { self.policy = unsafe { ::std::mem::transmute::<CheckPolicy, i32>(v) }; }
#[inline] pub fn get_policy(&self) -> CheckPolicy { unsafe { ::std::mem::transmute::<i32, CheckPolicy>(self.policy) } }
}
...
#[inline] pub fn get_new_peer_ids(&self) -> &:: std :: vec :: Vec < u64 > { &self.new_peer_ids }
...
#[inline] pub fn get_ids(&self) -> &:: std :: vec :: Vec < SplitId > { &self.ids }
...
#[inline] pub fn set_desc(&mut self, v: std :: vec :: Vec < u8 >) { self.desc = v; }
#[inline] pub fn get_desc(&self) -> &[u8] { &self.desc }
#[inline] pub fn mut_desc(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.desc }
#[inline] pub fn take_desc(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.desc, ::std::vec::Vec::new()) }
#[inline] pub fn clear_status(&mut self) { self.status = 0 }
#[inline] pub fn set_status_(&mut self, v: OperatorStatus) { self.status = unsafe { ::std::mem::transmute::<OperatorStatus, i32>(v) }; }
#[inline] pub fn get_status(&self) -> OperatorStatus { unsafe { ::std::mem::transmute::<i32, OperatorStatus>(self.status) } }
#[inline] pub fn clear_kind(&mut self) { self.kind.clear(); }
#[inline] pub fn set_kind(&mut self, v: std :: vec :: Vec < u8 >) { self.kind = v; }
#[inline] pub fn get_kind(&self) -> &[u8] { &self.kind }
#[inline] pub fn mut_kind(&mut self) -> &mut std :: vec :: Vec < u8 > { &mut self.kind }
#[inline] pub fn take_kind(&mut self) -> std :: vec :: Vec < u8 > { ::std::mem::replace(&mut self.kind, ::std::vec::Vec::new()) }
}
