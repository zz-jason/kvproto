...
pub trait Engine {
fn apply_command_batch(&mut self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<CommandRequestBatch>, sink: ::grpcio::DuplexSink<CommandResponseBatch>);
fn apply_snapshot(&mut self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<SnapshotRequest>, sink: ::grpcio::ClientStreamingSink<SnapshotDone>);
}
