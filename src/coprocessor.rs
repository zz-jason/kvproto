...
pub struct Response {
    ...
    pub runtime_details: ::protobuf::SingularPtrField<super::kvrpcpb::RunTimeDetails>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl Response {
    ...
    // .kvrpcpb.RunTimeDetails runtime_details = 6;

    pub fn clear_runtime_details(&mut self) {
        self.runtime_details.clear();
    }

    pub fn has_runtime_details(&self) -> bool {
        self.runtime_details.is_some()
    }

    // Param is passed by value, moved
    pub fn set_runtime_details(&mut self, v: super::kvrpcpb::RunTimeDetails) {
        self.runtime_details = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_runtime_details(&mut self) -> &mut super::kvrpcpb::RunTimeDetails {
        if self.runtime_details.is_none() {
            self.runtime_details.set_default();
        }
        self.runtime_details.as_mut().unwrap()
    }

    // Take field
    pub fn take_runtime_details(&mut self) -> super::kvrpcpb::RunTimeDetails {
        self.runtime_details.take().unwrap_or_else(|| super::kvrpcpb::RunTimeDetails::new())
    }

    pub fn get_runtime_details(&self) -> &super::kvrpcpb::RunTimeDetails {
        self.runtime_details.as_ref().unwrap_or_else(|| super::kvrpcpb::RunTimeDetails::default_instance())
    }

    fn get_runtime_details_for_reflect(&self) -> &::protobuf::SingularPtrField<super::kvrpcpb::RunTimeDetails> {
        &self.runtime_details
    }

    fn mut_runtime_details_for_reflect(&mut self) -> &mut ::protobuf::SingularPtrField<super::kvrpcpb::RunTimeDetails> {
        &mut self.runtime_details
    }
}
...
impl ::protobuf::Message for Response {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                6 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.runtime_details)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.runtime_details.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static(_: ::std::option::Option<Response>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::kvrpcpb::RunTimeDetails>>(
                    "runtime_details",
                    Response::get_runtime_details_for_reflect,
                    Response::mut_runtime_details_for_reflect,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x04\x20\x03(\x0b2\x15.coprocessor.KeyRangeR\x06ranges\"\xc5\x02\n\
    ...
    e\x18\x05\x20\x01(\x0b2\x15.coprocessor.KeyRangeR\x05range\x12@\n\x0frun\
    time_details\x18\x06\x20\x01(\x0b2\x17.kvrpcpb.RunTimeDetailsR\x0eruntim\
    eDetailsB&\n\x18com.pingcap.tikv.kvproto\xe0\xe2\x1e\x01\xd0\xe2\x1e\x01\
    \xc8\xe2\x1e\x01J\xea\x0b\n\x06\x12\x04\0\0!\x01\n\x08\n\x01\x0c\x12\x03\
    ...
    \x02\x01\x12\x03\x10\x04\x12\n\r\n\x05\x04\0\x02\x01\x04\x12\x04\x10\x04\
    ...
    \x06\x12\x03\x14\x04\x13\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x14\x14\
    \x1b\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\x14\x1e\x1f\n\x0b\n\x04\x04\
    \x01\x02\x01\x12\x03\x15\x04\x11\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04\
    ...
    \x01\x02\x02\x05\x12\x03\x16\x04\t\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\
    ...
    \x02\x03\x03\x12\x03\x17\x1f\x20\n\n\n\x02\x04\x02\x12\x04\x1a\0!\x01\n\
    ...
    \0\x08\xe7\x07\x01\x02\x12\x03\x1b`t\n\x11\n\n\x04\x02\x02\0\x08\xe7\x07\
    \x01\x02\0\x12\x03\x1b`t\n\x12\n\x0b\x04\x02\x02\0\x08\xe7\x07\x01\x02\0\
    \x01\x12\x03\x1bas\n\x10\n\t\x04\x02\x02\0\x08\xe7\x07\x01\x03\x12\x03\
    \x1bw|\n\x0b\n\x04\x04\x02\x02\x01\x12\x03\x1c\x04#\n\r\n\x05\x04\x02\
    \x02\x01\x04\x12\x04\x1c\x04\x1b~\n\x0c\n\x05\x04\x02\x02\x01\x06\x12\
    ...
    \x05\x04\x02\x02\x05\x06\x12\x03\x20\x04\x1a\n\x0c\n\x05\x04\x02\x02\x05\
