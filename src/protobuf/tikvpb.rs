...
impl<'a> ::std::default::Default for &'a BatchCommandsRequest_Request {
    fn default() -> &'a BatchCommandsRequest_Request {
        <BatchCommandsRequest_Request as ::protobuf::Message>::default_instance()
    }
}
...
impl<'a> ::std::default::Default for &'a BatchCommandsResponse_Response {
    fn default() -> &'a BatchCommandsResponse_Response {
        <BatchCommandsResponse_Response as ::protobuf::Message>::default_instance()
    }
}
